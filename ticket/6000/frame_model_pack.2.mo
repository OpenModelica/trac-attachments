package frame_model_pack
  ...
  equation
    connect(world.frame_b, keel.frame_a) annotation(
      Line(points = {{-164, 14}, {-134, 14}, {-134, 10}, {-106, 10}}, color = {95, 95, 95}));
  connect(keel.LE_hinge_R, LE_hinge_R.frame_a) annotation(
      Line(points = {{-98, 20}, {-94, 20}, {-94, 30}, {-92, 30}}));
  connect(keel1.frame_a, LE_hinge_R.frame_b) annotation(
      Line(points = {{-78, 74}, {-92, 74}, {-92, 50}, {-92, 50}}));
  connect(keel.TOU_anchor, control_Frame.TOU_conn) annotation(
      Line(points = {{-48, 10}, {-36, 10}, {-36, -28}, {-34, -28}}, color = {95, 95, 95}));
    annotation(
...
equation
  ...
  model new_frame_model
  Keel keel annotation(
      Placement(visible = true, transformation(origin = {-122, 6}, extent = {{-50, -10}, {50, 10}}, rotation = 0)));
  Control_Frame control_Frame annotation(
      Placement(visible = true, transformation(origin = {-104, -48}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  inner Modelica.Mechanics.MultiBody.World world annotation(
      Placement(visible = true, transformation(origin = {-272, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(world.frame_b, keel.frame_a) annotation(
      Line(points = {{-262, 2}, {-174, 2}, {-174, 6}, {-172, 6}}, color = {95, 95, 95}));
  connect(keel.TOU_anchor, control_Frame.TOU_conn) annotation(
      Line(points = {{-114, 6}, {-104, 6}, {-104, -28}, {-104, -28}}, color = {95, 95, 95}));
    annotation(
      Icon(coordinateSystem(extent = {{-500, -100}, {500, 100}})),
      Diagram(coordinateSystem(extent = {{-500, -100}, {500, 100}})));
  end new_frame_model;

package grid
  ...
  package filter
    model pi
      ...
      parameter SI.Capacitance C4(start = 0.00001);
      parameter SI.Capacitance C5(start = 0.00001);
      parameter SI.Capacitance C6(start = 0.00001);
      parameter SI.Inductance L1(start = 0.001);
      parameter SI.Inductance L2(start = 0.001);
      parameter SI.Inductance L3(start = 0.001);
      parameter SI.Resistance R1(start = 0.01);
      parameter SI.Resistance R2(start = 0.01);
      parameter SI.Resistance R3(start = 0.01);
      parameter SI.Resistance R4(start = 0.01);
      parameter SI.Resistance R5(start = 0.01);
      parameter SI.Resistance R6(start = 0.01);
      parameter SI.Resistance R7(start = 0.01);
      parameter SI.Resistance R8(start = 0.01);
      parameter SI.Resistance R9(start = 0.01);
    ...
    model lcl
      ...
      parameter SI.Inductance L2(start = 0.001);
      parameter SI.Inductance L3(start = 0.001);
      parameter SI.Inductance L4(start = 0.001);
      parameter SI.Inductance L5(start = 0.001);
      parameter SI.Inductance L6(start = 0.001);
      parameter SI.Resistance R1(start = 0.01);
      parameter SI.Resistance R2(start = 0.01);
      parameter SI.Resistance R3(start = 0.01);
      parameter SI.Resistance R4(start = 0.01);
    ...
    model lclc
      ...
      parameter SI.Resistance R8(start = 0.01);
      parameter SI.Resistance R9(start = 0.01);
      parameter SI.Resistance R10(start = 0.01);
      parameter SI.Resistance R11(start = 0.01);
      parameter SI.Resistance R12(start = 0.01);
      Modelica.Electrical.Analog.Basic.Inductor inductor1(L = L1) annotation(
  ...
  package loads
    model rc
      parameter SI.Resistance R1(start = 20);
      parameter SI.Resistance R2(start = 20);
      parameter SI.Resistance R3(start = 20);
      parameter SI.Capacitance C1(start = 0.00001);
      parameter SI.Capacitance C2(start = 0.00001);
      parameter SI.Capacitance C3(start = 0.00001);
      Modelica.Electrical.Analog.Interfaces.Pin pin1 annotation(
...
<li><em> 1998   </em>
  ...
  grid.inverters.inverter inverter2 annotation(
      Placement(visible = true, transformation(origin = {-70, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  grid.filter.lcl lcl1 annotation(
      Placement(visible = true, transformation(origin = {-30, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  equation
    ...
    connect(lcl1.pin4, lc2.pin1) annotation(
      Line(points = {{-20, -36}, {8, -36}, {8, 24}, {20, 24}}, color = {0, 0, 255}));
    connect(lcl1.pin5, lc2.pin2) annotation(
      Line(points = {{-20, -30}, {0, -30}, {0, 30}, {20, 30}}, color = {0, 0, 255}));
    connect(lcl1.pin6, lc2.pin3) annotation(
      Line(points = {{-20, -24}, {-6, -24}, {-6, 36}, {20, 36}}, color = {0, 0, 255}));
    ...
    connect(inverter2.pin3, lcl1.pin3) annotation(
      Line(points = {{-60, -24}, {-50, -24}, {-50, -24}, {-40, -24}, {-40, -24}, {-40, -24}}, color = {0, 0, 255}));

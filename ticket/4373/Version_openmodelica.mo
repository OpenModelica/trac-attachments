within ;
package Version_openmodelica

  package Experiment

    model Experiment_1
      // Experiment: a simulation package in Modelica , to simulate the  simple model.
      Version_openmodelica.Vehicles.vehicle vehicle;
  ...
  package Vehicles
    ...
    model vehicle
      ...
      Version_openmodelica.Driveline.transmission_modular trans(m=chassis.m,
          st_agear=st_agear);
      Version_openmodelica.body_and_wheel.chassis chassis;
      Version_openmodelica.body_and_wheel.wheel wheel1(m=chassis.m_f);
      Version_openmodelica.body_and_wheel.wheel wheel2(m=chassis.m_r);
      Version_openmodelica.body_and_wheel.brakes brake;
  ...
  package Driveline
    ...
    model transmission_modular
      extends Version_openmodelica.Driveline.engine_modular;
      import SI = Modelica.SIunits;
      constant Real pi = Modelica.Constants.pi;

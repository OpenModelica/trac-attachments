package AC_OM_Working
  ...
  model gridTest21
    ...
    Modelica.Blocks.Sources.Constant pos1(k = 1000) annotation(Placement(transformation(extent = {{-60, -10}, {-40, 10}})));
  ...
  equation
    ...
    connect(gridOneTrack.trainPos[1], pos1.y) annotation(Line(points = {{-24.6875, 0.333333}, {-32, 0.333333}, {-32, 0}, {-39, 0}}, color = {0, 0, 127}, smooth = Smooth.None));

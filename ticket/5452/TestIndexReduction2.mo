...
model TestIndexReduction2
  ...
  Modelica.Electrical.Analog.Basic.Ground ground1
                                                 annotation (Placement(
        transformation(origin={48,-48},  extent={{-10,-10},{10,10}})));
equation
  ...
  connect(inverter.ac, resistor1.plug_n)
    annotation (Line(points={{10,70},{48,70},{48,58}}, color={0,0,255}));
  connect(resistor1.plug_p, star1.plug_p)
    annotation (Line(points={{48,38},{48,28}}, color={0,0,255}));
  connect(star1.pin_n, inductor1.p)
    annotation (Line(points={{48,8},{48,-10}}, color={0,0,255}));
  connect(inductor1.n, ground1.p)
    annotation (Line(points={{48,-30},{48,-38}}, color={0,0,255}));

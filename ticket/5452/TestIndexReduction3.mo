...
model TestIndexReduction3
  ...
  parameter Modelica.SIunits.Resistance RLoad = 1;
...
equation
  ...
  connect(inductor.plug_n, delta.plug_p)
    annotation (Line(points={{-80,70},{-48,70}}, color={0,0,255}));
  connect(delta.plug_p, resistor1.plug_n)
    annotation (Line(points={{-48,70},{-48,44},{-46,44}}, color={0,0,255}));
  connect(delta.plug_n, resistor1.plug_p)
    annotation (Line(points={{-28,70},{-28,44},{-26,44}}, color={0,0,255}));

...
# the original package tarball disappeared, so build it from SVN source
ESVN_REPO_URI="https://openmodelica.ida.liu.se/svn/OpenModelica/trunk"
...
src_unpack() {
	...
	epatch "${FILESDIR}/OpenModelica-1.4.5-build_fixes.patch"

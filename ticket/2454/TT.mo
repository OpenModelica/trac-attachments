model simple_triggered_trapezoid "C2M2L_OM Range Pack Internals includes a triggered trapezoid.  This requires when equations and initial equations"
...
end simple_triggered_trapezoid;

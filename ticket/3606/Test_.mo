package Test "Package without if inside the battery, and without explicit loss"
  ...
  package Components
    ...
    model AddPcLossesOld "Simplified losses of a generalised ICE. First release: two straight line segments"
      ...
      parameter Real slope = 1.45 "watts of losses per delivered watt avobe the corner point";
      Modelica.Blocks.Interfaces.RealOutput y annotation(Placement(visible = true, transformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput u "input fuel power" annotation(Placement(visible = true, transformation(extent = {{-138, -20}, {-98, 20}}, rotation = 0), iconTransformation(extent = {{-140, -20}, {-100, 20}}, rotation = 0)));
      //  Modelica.SIunits.Power losses annotation(Placement(visible = true, transformation(origin = {120, -26}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      Modelica.Blocks.Interfaces.RealOutput losses annotation(Placement(visible = true, transformation(origin = {0, -110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    ...
    model AddLosses "Simplified losses of a generalised ICE. First release: two straight line segments"
      // Le perdite sono calcolate come dall'analisi della mappa della Prius che porta a mostrare
...
<p>It is useful for usage in simplified models for dynamic optiimisation for electricd and hybrid vehicles.</p>
    ...
    model Efficiency "Elementary primary converter: generates the required power with efficiency"
      //computes consumption from a map (efficiency as a function of the delivered power)
      Real eff;
      parameter Real pNom = 1.0e4;
      parameter Real A = -0.5 "efficiency reduction when p-p0=pNom";
      parameter Real p0 = 0.8 * pNom "Power having maximum efficiency";
      parameter Real maxEff = 0.8 " maximum efficiency";
      Modelica.Blocks.Interfaces.RealOutput y annotation(Placement(visible = true, transformation(origin = {110, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput u "input fuel power" annotation(Placement(visible = true, transformation(extent = {{-138, -20}, {-98, 20}}, rotation = 0), iconTransformation(extent = {{-140, -20}, {-100, 20}}, rotation = 0)));
    equation
      y = u * eff;
      //The efficiency is a parabola as function of the delivered power
      eff = A * ((u - p0) / pNom) ^ 2 + maxEff;
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 24}, {100, -34}}, textString = "eta"), Text(lineColor = {0, 0, 255}, fillColor = {0, 0, 127}, fillPattern = FillPattern.Solid, extent = {{-100, 145}, {98, 105}}, textString = "%name")}));
    end Efficiency;

    model AddPcLossesOO "Adds Primary Converter Losses, considering On/Off input signal"
...
OO")}));
    ...
    model PowOO "Adds Primary Converter Losses, considering On/Off input signal"
      Modelica.Blocks.Interfaces.BooleanInput n "On Signal" annotation(Placement(transformation(extent = {{-140, -80}, {-100, -40}})));
      Modelica.Blocks.Interfaces.RealInput u "mechanical outpu PC power" annotation(Placement(transformation(extent = {{-140, 40}, {-100, 80}})));
      Modelica.Blocks.Logical.Switch switch2 annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {38, 0})));
      Modelica.Blocks.Interfaces.RealOutput y annotation(Placement(transformation(extent = {{100, -10}, {120, 10}})));
    ...
    equation
      ...
      connect(n, switch2.u2) annotation(Line(points = {{-120, -60}, {-72, -60}, {-72, 0}, {26, 0}}, color = {255, 0, 255}, smooth = Smooth.None));
      connect(switch2.y, y) annotation(Line(points = {{49, 0}, {110, 0}}, color = {0, 0, 127}, smooth = Smooth.None));
      connect(switch2.u1, u) annotation(Line(points = {{26, 8}, {-72, 8}, {-72, 60}, {-120, 60}}, color = {0, 0, 127}, smooth = Smooth.None));
      annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Line(points = {{-106, 62}, {0, -2}, {100, -2}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{-104, -58}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{-38, 16}, {-94, -56}}, color = {255, 0, 255}, smooth = Smooth.None), Polygon(points = {{-37, 18}, {-49, 10}, {-39, 4}, {-37, 18}}, lineColor = {255, 0, 255}, smooth = Smooth.None, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Polygon(points = {{-95, -58}, {-83, -50}, {-93, -44}, {-95, -58}}, lineColor = {255, 0, 255}, smooth = Smooth.None, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Text(extent = {{-102, 140}, {98, 100}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, textString = "%name")}));
    end PowOO;

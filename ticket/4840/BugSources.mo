model BugSources
  ...
  Modelica.Electrical.MultiPhase.Sources.SineVoltage sineVoltage( V = 100 * sqrt(2) * ones(3),freqHz = 50 * ones(3)) annotation(
...
equation
  ...
  connect(sineVoltage.plug_p, resistor1.plug_p) annotation(

model DamperBug3
  ...
  Modelica.Mechanics.Rotational.Components.Spring spring1(c = 7500) annotation(Placement(visible = true, transformation(origin = {-4.31655,40.2878}, extent = {{-12,-12},{12,12}}, rotation = 0)));
equation
  connect(spring1.flange_b,idealrollingwheel1.flangeR) annotation(Line(points = {{7.68345,40.2878},{18.705,40.2878},{18.705,40.2878},{18.5036,40.2878}}));
  connect(spring1.flange_a,inertia1.flange_b) annotation(Line(points = {{-16.3165,40.2878},{-20.7194,40.2878},{-20.7194,25.3237},{-27.3355,25.3237},{-27.3355,25.2085}}));

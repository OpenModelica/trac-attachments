package TestStreamConnectors
  ...
  TestStreamConnectors.Components.PressureSource source2(T = 40, p = 2)  annotation(
        Placement(visible = true, transformation(origin = {0, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.Pipe pipe1 annotation(
        Placement(visible = true, transformation(origin = {50, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.Pipe pipe2 annotation(
        Placement(visible = true, transformation(origin = {50, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
  ...
  package TestModels
    ...
    model Test2
      extends Modelica.Icons.Example;
      TestStreamConnectors.Components.PressureSource source(p = 2)  annotation(
        Placement(visible = true, transformation(origin = {-62, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.Pipe pipe1 annotation(
        Placement(visible = true, transformation(origin = {-20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.Pipe pipe2 annotation(
        Placement(visible = true, transformation(origin = {20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.PressureSource sink(T = 0)  annotation(
...
<p>Flow reversal not allowed, so</p><p>pipe1.h =<br> actualStream(pipe1.inlet.h_outflow) =<br> source.flange.h_outflow =<br>80000</p>
</body></html>"));
    end Test2;
    ...
    model Test5
      ...
      TestStreamConnectors.Components.PressureSource source(p = 2) annotation(
        Placement(visible = true, transformation(origin = {-62, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.Pipe pipe1(allowFlowReversal = true)  annotation(
        Placement(visible = true, transformation(origin = {-20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.Pipe pipe2(allowFlowReversal = true)  annotation(
        Placement(visible = true, transformation(origin = {20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.PressureSource sink annotation(
        Placement(visible = true, transformation(origin = {60, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.PressureSensor sensor annotation(
...
80000.</p>
    ...
    equation
      ...
      annotation(
        ...
        Documentation(info = "<html><head></head><body><p>One-to-one connections.</p>
<p>pipe2.outlet.h_outflow =<br>inStream(pipe2.inlet.h_outflow) =<br> pipe1.outlet.h_outflow =<br>inStream(pipe1.inlet.h_outflow) =<br>source.flange.h_outflow =<br>80000.</p>
<p>Flow reversal is allowed, so</p>
<p>pipe1.h =<br>actualStream(pipe1.inlet.h_outflow) =<br>
smooth(0, if pipe1.inlet.m_flow&gt;0 then inStream(pipe1.inlet.h_outflow) else pipe1.inlet.h_outflow) =<br>
smooth(0, if pipe1.inlet.m_flow&gt;0 then source.flange.h_outflow else inStream(pipe1.outlet.h_outflow)) =<br>
smooth(0, if pipe1.inlet.m_flow&gt;0 then source.flange.h_outflow else pipe2.inlet.h_outflow) =<br>
smooth(0, if pipe1.inlet.m_flow&gt;0 then source.flange.h_outflow else inStream(pipe2.outlet.h_outflow)) =<br>
smooth(0, if pipe1.inlet.m_flow&gt;0 then source.flange.h_outflow else sink.flange.h_outflow) =<br>
smooth(0, if pipe1.inlet.m_flow&gt;0 then source.h else sink.h) =<br>
80000</p>
</body></html>"));
    end Test3;
    ...
    model Test6
      extends Modelica.Icons.Example;
      TestStreamConnectors.Components.PressureSource sink(p = 0)  annotation(
        Placement(visible = true, transformation(origin = {70, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.PressureSource source1(T = 100)  annotation(
        Placement(visible = true, transformation(origin = {-70, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.PressureSource source2(T = 50)  annotation(
        Placement(visible = true, transformation(origin = {-70, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.Pipe pipe1 annotation(
        Placement(visible = true, transformation(origin = {-20, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.Pipe pipe2 annotation(
        Placement(visible = true, transformation(origin = {-20, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.Pipe pipe3 annotation(
...
200000</p>
    ...
    model Test7
      ...
      TestStreamConnectors.Components.Pipe pipe2(allowFlowReversal = true)  annotation(
        Placement(visible = true, transformation(origin = {-20, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.Pipe pipe3(allowFlowReversal = true)  annotation(
        Placement(visible = true, transformation(origin = {26, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(source2.flange, pipe2.inlet) annotation(
        Line(points = {{-70, -20}, {-30, -20}, {-30, -20}, {-30, -20}}));
...
inStream(pipe1.outlet.h_outflow)=<br>(max(-pipe2.outlet.m_flow, 1e-7)*pipe2.outlet.h_outflow + max(pipe3.outlet.m_flow,1e-7)*pipe3.outlet.h_outflow)/(max(-pipe3.outlet.m_flow, 1e-7) + max(pipe3.outlet.m_flow,1e-7)</p>
    ...
    model Test8
      extends Modelica.Icons.Example;
      TestStreamConnectors.Components.PressureSource sink3 annotation(
      ...
      TestStreamConnectors.Components.Pipe pipe3 annotation(
        Placement(visible = true, transformation(origin = {20, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.PressureSource sink2 annotation(
        Placement(visible = true, transformation(origin = {60, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
  ...
  connect(pipe1.outlet, pipe3.inlet) annotation(
      ...
      annotation(
        experiment(StopTime = 1),
        Documentation(info = "<html><head></head><body><p>Fan-out 2-to-one connection, flow reversal not allowed (m_flow.min=0 on all inlets).</p>
...
80000</p>
    ...
    model Test9
      extends Modelica.Icons.Example;
      TestStreamConnectors.Components.PressureSource sink3(T = 50, p = 1.6)  annotation(
        Placement(visible = true, transformation(origin = {60, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.PressureSource source(p = 2) annotation(
        Placement(visible = true, transformation(origin = {-60, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.Pipe pipe1 annotation(
        Placement(visible = true, transformation(origin = {-20, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.Pipe pipe2(allowFlowReversal = false)  annotation(
        Placement(visible = true, transformation(origin = {20, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.Pipe pipe3(allowFlowReversal = true)  annotation(
        Placement(visible = true, transformation(origin = {20, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TestStreamConnectors.Components.PressureSource sink2 annotation(
...
95000.</p>
    ...
    model Test10
      extends Modelica.Icons.Example;
  TestStreamConnectors.Components.Mixer mixer annotation(
        Placement(visible = true, transformation(origin = {-30, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TestStreamConnectors.Components.Pipe pipe annotation(

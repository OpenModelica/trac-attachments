...
<td><p>Initial implementation and documentation</p></td>
      ...
      model Deformation
        ...
        parameter SI.TranslationalSpringConstant c1
          "stiffness elastic compression";
        parameter SI.TranslationalSpringConstant c2
          "stiffness plastic compression";
        parameter SI.TranslationalSpringConstant c3
          "stiffness decompression compression";
      ...
      algorithm
        ...
        elsewhen Deformationsmode == compression and v < 0 and s < Smax -
            minPos then
          Deformationsmode:=decompression;
        elsewhen Deformationsmode == decompression and flange_a.f >
            0.0000000001 then
          Deformationsmode:=zero_force;
          s3:=s;
        elsewhen Deformationsmode == zero_force and s > s3 and v > 0 and n <
            nmax and Multistroke then
          Deformationsmode:=compression;
          n:=n + 1;
        elsewhen Deformationsmode == decompression and v > 0 and s > Smax -
            minPos then
          Deformationsmode:=compression;
        elsewhen Deformationsmode == zero_force and s < L then
          Deformationsmode:=idle_stroke;
        elsewhen Deformationsmode == zero_force and s > s3 and v < 0 and not
            Multistroke then
          Deformationsmode:=decompression;
        end when;
      equation
        ...
        annotation(Diagram(coordinateSystem(extent = {{-100,-120},{100,80}})), Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Line(points = {{-80,80},{-80,-80},{80,-80}}, color = {0,0,0}, smooth = Smooth.None),Polygon(points = {{-60,-80},{-40,20},{80,60},{40,-80},{-60,-80}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-88,48},{-56,26}}, lineColor = {0,0,0}, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "F
"),           Text(
                extent={{54,-74},{98,-98}},
                lineColor={0,0,0},
...
<td><p>Documentation</p></td>
      ...
      equation
        ...
        annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
              ...
              Line(
                points={{-80,60},{-80,-60},{60,-60},{60,-20}},
                color={0,0,0},
                smooth=Smooth.None),
              Rectangle(
                extent={{-60,60},{80,20}},
                ...
                pattern=LinePattern.None),
              Line(
                points={{-60,20},{-60,60},{80,60},{80,0},{100,0}},
                pattern=LinePattern.None,
                smooth=Smooth.None)}));
      end DryFricStribeck;
      ...
      equation
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Line(points = {{-84,40},{-58,40}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Text(extent = {{-24,76},{24,12}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5,
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "F"),Line(points = {{58,40},{82,40}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Line(points = {{70,50},{70,26}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Polygon(points = {{10,2},{10,-2},{70,-2},{70,-10},{80,0},{70,10},{70,2},{10,2}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-10,2},{-10,-2},{-70,-2},{-70,-10},{-80,0},{-70,10},{-70,2},{-10,2}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid)}), Diagram(graphics), Diagram(graphics), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model ForceVariable "\"Transforms  signals to forces"
        ...
        Modelica.Mechanics.Translational.Interfaces.Flange_a flange_a
          "(left) driving flange (flange axis directed in to cut plane, e. g. from left to right)"
                                                                                                              annotation(Placement(transformation(extent = {{-110,-10},{-90,10}}, rotation = 0), iconTransformation(extent = {{-110,-10},{-90,10}})));
        Modelica.Mechanics.Translational.Interfaces.Flange_b flange_b
          "(right) driven flange (flange axis directed out of cut plane)"                                                             annotation(Placement(transformation(extent = {{90,-10},{110,10}}, rotation = 0), iconTransformation(extent = {{90,-10},{110,10}})));
      ...
      equation
        ...
        annotation(Diagram(graphics), Icon(graphics={  Line(points = {{-84,40},{-58,40}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Text(extent = {{-24,76},{24,12}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5,
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "F"),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Line(points = {{58,40},{82,40}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Line(points = {{70,50},{70,26}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Polygon(points = {{10,2},{10,-2},{70,-2},{70,-10},{80,0},{70,10},{70,2},{10,2}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-10,2},{-10,-2},{-70,-2},{-70,-10},{-80,0},{-70,10},{-70,2},{-10,2}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Diagram(graphics), Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Rectangle(extent = {{-60,20},{60,-40}}, lineColor = {0,0,0}, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-50,16},{48,-26}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m")}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model MassEndstop
        ...
        parameter Real restitutionCoefficient(min = 5, max = 100, displayUnit = "%") = 5
          "damping constant"                                                                                annotation(Dialog(group = "Hard stop"));
        parameter SI.Mass m = 1 "Mass";
      ...
      equation
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Rectangle(extent = {{-60,20},{60,-40}}, lineColor = {0,0,0}, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-50,16},{48,-26}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Polygon(points = {{-80,0},{-80,-60},{80,-60},{80,0},{100,0},{100,-80},{-100,-80},{-100,0},{-80,0}}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0})}), Diagram(graphics), Documentation(info = "<HTML>
...
<table border=0 cellspacing=0 cellpadding=2>
  <tr>
    <td>
      <img src=\"W:\10_ETI22\__Kollegen\_SvenBätzing\DC_Mechlib\images\damping-constant.jpg\" width=\"1000\" align=\"center\">
    </td>
  </tr>
...
<table border=0 cellspacing=0 cellpadding=2>
  <tr>
    <td>
       <img src=\"W:\10_ETI22\__Kollegen\_SvenBätzing\DC_Mechlib\images\states.jpg\" width=\"800\" align=\"center\">
    </td>
  </tr>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model MassFriction
        ...
        parameter SI.Acceleration g = 0 "gravity";
        parameter Real vis = 0 "viscous friction value in Ns/mm " annotation(Dialog(group = "Friction"));
        parameter SI.Velocity vh(min = 1e-11) = 0.000001
          "static velocity limit"                                                annotation(Dialog(group = "Friction"));
        parameter Boolean initialize_s = true annotation(Dialog(group = "Initialization"));
        parameter Boolean initialize_v = true annotation(Dialog(group = "Initialization"));
        parameter SI.Position s_init = 0 annotation(Dialog(group = "Initialization"));
        parameter SI.Velocity v_init = 0 annotation(Dialog(group = "Initialization"));
      ...
      equation
        ...
        annotation(Icon(graphics={  Polygon(points = {{-100,-60},{-80,-50},{-80,-60},{-60,-50},{-60,-60},{-40,-50},{-40,-60},{-20,-50},{-20,-60},{0,-50},{0,-60},{20,-50},{20,-60},{40,-50},{40,-60},{60,-50},{60,-50},{60,-60},{80,-50},{80,-60},{-100,-60}}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Polygon(points = {{80,-60},{100,-50},{100,-60},{100,-80},{-100,-80},{-100,-60},{80,-60}}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Rectangle(extent = {{-60,20},{60,-40}}, lineColor = {0,0,0}, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-50,16},{48,-26}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Line(points = {{-100,-60},{80,-60}}, color = {135,135,135}, smooth = Smooth.None)}), DymolaStoredErrors, Documentation(info = "<HTML>
...
<table border=0 cellspacing=0 cellpadding=2>
  <tr>
    <td>
      <img src=\"W:\10_ETI22\__Kollegen\_SvenBätzing\DC_Mechlib\images\statesfriction.jpg\" width=\"800\" align=\"center\">
    </td>
  </tr>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model MassFrictionEndstop
        ...
        parameter SI.Position lowlim = -0.5 "Lower Limit of endstop" annotation(Dialog(group = "Hard stop"));
        parameter SI.Position uplim = 0.5 "Upper limit of endstop" annotation(Dialog(group = "Hard stop"));
        parameter Real restitutionCoefficient(min = 5, max = 100) = 5
          "damping endstop in percentage"                                                             annotation(Dialog(group = "Hard stop"));
        parameter Boolean initialize_s = true annotation(Dialog(group = "Initialization"));
        parameter Boolean initialize_v = true annotation(Dialog(group = "Initialization"));
        parameter SI.Position s_init = 0 annotation(Dialog(group = "Initialization"));
        parameter SI.Velocity v_init = 0 annotation(Dialog(group = "Initialization"));
      ...
      //                      //
        ...
        acce = der(v);
        flange_a.s = flange_b.s;
        annotation(Placement(transformation(extent = {{-46,-10},{-26,10}})), Diagram(graphics), Icon(graphics={  Polygon(points = {{-100,-60},{-80,-50},{-80,-60},{-60,-50},{-60,-60},{-40,-50},{-40,-60},{-20,-50},{-20,-60},{0,-50},{0,-60},{20,-50},{20,-60},{40,-50},{40,-60},{60,-50},{60,-50},{60,-60},{80,-50},{80,-60},{-100,-60}}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Polygon(points = {{80,-60},{100,-50},{100,-60},{100,-80},{-100,-80},{-100,-60},{80,-60}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0},
                  lineThickness =                                                                                                    1),Rectangle(extent = {{-80,0},{-100,-68}}, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, pattern = LinePattern.None),Rectangle(extent = {{100,0},{80,-68}}, pattern = LinePattern.None, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Rectangle(extent = {{-60,20},{60,-40}}, lineColor = {0,0,0}, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-50,16},{48,-26}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Line(points = {{-80,-60},{-80,0},{-90,0}}, pattern = LinePattern.None, smooth = Smooth.None),Line(points = {{-100,-80},{100,-80}}, pattern = LinePattern.None, smooth = Smooth.None),Line(points = {{80,-50},{80,0},{90,0}}, pattern = LinePattern.None, smooth = Smooth.None)}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model Position "Transform a Signal to a Position"
        ...
        Modelica.Blocks.Interfaces.RealInput s_ref
          "Reference position of flange as input signal"                                          annotation(Placement(transformation(extent = {{-126,-20},{-86,20}}, rotation = 0), iconTransformation(extent = {{-126,-20},{-86,20}})));
      equation
        if unit == "mm" then
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Line(points = {{-40,50},{-60,50},{-60,-50},{-48,-50},{-48,-42}}, color = {0,0,0}, smooth = Smooth.None),Rectangle(extent = {{-48,-38},{8,-64}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid),Line(points = {{8,-38},{16,-38}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{8,-64},{16,-64}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{8,-52},{60,-52},{60,50},{40,50}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{40,50},{36,30},{26,70},{16,30},{6,70},{-4,30},{-14,70},{-24,30},{-34,70}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-34,70},{-40,50}}, color = {0,0,0}, smooth = Smooth.None)}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100,-100},{100,100}}), graphics={  Ellipse(extent = {{-100,78},{-100,76}}, lineColor = {0,0,255}),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Polygon(points = {{-60,40},{-58,44},{-56,46},{-52,48},{-48,48},{-44,46},{-42,44},{-40,40},{-60,-40},{-62,-44},{-64,-46},{-68,-48},{-72,-48},{-76,-46},{-78,-44},{-80,-40},{-60,40}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {215,215,215},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-40,40},{-38,44},{-36,46},{-32,48},{-28,48},{-24,46},{-22,44},{-20,40},{-40,-40},{-42,-44},{-44,-46},{-48,-48},{-52,-48},{-56,-46},{-58,-44},{-60,-40},{-40,40}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {215,215,215},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{40,40},{42,44},{44,46},{48,48},{52,48},{56,46},{58,44},{60,40},{40,-40},{38,-44},{36,-46},{32,-48},{28,-48},{24,-46},{22,-44},{20,-40},{40,40}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {215,215,215},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{20,40},{22,44},{24,46},{28,48},{32,48},{36,46},{38,44},{40,40},{20,-40},{18,-44},{16,-46},{12,-48},{8,-48},{4,-46},{2,-44},{0,-40},{20,40}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {215,215,215},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{0,40},{2,44},{4,46},{8,48},{12,48},{16,46},{18,44},{20,40},{0,-40},{-2,-44},{-4,-46},{-8,-48},{-12,-48},{-16,-46},{-18,-44},{-20,-40},{0,40}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {215,215,215},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-20,40},{-18,44},{-16,46},{-12,48},{-8,48},{-4,46},{-2,44},{0,40},{-20,-40},{-22,-44},{-24,-46},{-28,-48},{-32,-48},{-36,-46},{-38,-44},{-40,-40},{-20,40}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {215,215,215},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{60,40},{62,44},{64,46},{68,48},{72,48},{76,46},{78,44},{80,40},{60,-40},{58,-44},{56,-46},{52,-48},{48,-48},{44,-46},{42,-44},{40,-40},{60,40}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {215,215,215},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-60,82},{-60,78},{50,78},{50,70},{60,80},{50,90},{50,82},{-60,82}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid)}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100,-100},{100,100}}), graphics), Documentation(info = "<HTML>
...
<td><p>Further implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Diagram(graphics), Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Line(points = {{-40,50},{-60,50},{-60,-50},{-48,-50},{-48,-42}}, color = {0,0,0}, smooth = Smooth.None),Rectangle(extent = {{-48,-38},{8,-64}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid),Line(points = {{8,-38},{16,-38}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{8,-64},{16,-64}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{8,-52},{60,-52},{60,50},{40,50}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{40,50},{36,30},{26,70},{16,30},{6,70},{-4,30},{-14,70},{-24,30},{-34,70}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-34,70},{-40,50}}, color = {0,0,0}, smooth = Smooth.None)}), Documentation(info = "<HTML>
...
<td><p>Further implementation and documentation</p></td>
      ...
      equation
        ...
        Slip = initial() and abs(deltav) > velLimit/5 or pre(StartSlip) and abs(deltav) > velLimit/5 or pre(Slip) and abs(deltav) > velLimit/5;
        StartSlip = pre(Stick) and abs(Ffric) > Fh or pre(StartSlip) and not (deltav > velLimit/5 or aA-aB <= 0);
        Stick =initial() and abs(deltav) < velLimit or not (Slip or StartSlip);
        ...
        aA = if None then (flange_a.f - deltav * vis + mA * g) / mA else
             if Stick then (flange_a.f + flange_b.f + g * (mA + mB)) / (mA + mB) else (flange_a.f - Ffric + g * mA) / mA;
        aB = if None then (flange_b.f - deltav * vis + mB * g) / mB else
             if Stick then (flange_a.f + flange_b.f + g * (mA + mB)) / (mA + mB) else (flange_b.f + Ffric + g * mB) / mB;

        Ffric = if Stick then flange_a.f - ((flange_a.f + flange_b.f) / (mA + mB)) * mA else if StartSlip or Slip then F_stribeck else 0;

        annotation(Icon(graphics={  Rectangle(extent = {{-60,80},{60,20}}, lineColor = {0,0,0}, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{-60,-20},{60,-80}}, lineColor = {0,0,0}, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-80,4},{-80,-14},{-60,-4},{-60,-14},{-40,-4},{-40,-14},{-20,-4},{-20,-14},{0,-4},{0,-14},{20,-4},{20,-14},{40,-4},{40,-14},{60,-4},{60,-14},{80,-4},{80,14},{60,4},{60,14},{40,4},{40,14},{20,4},{20,14},{0,4},{0,14},{-20,4},{-20,14},{-40,4},{-40,14},{-60,4},{-60,14},{-80,4}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-62,74},{36,32}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Text(extent = {{-54,-30},{24,-70}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Text(extent = {{-36,74},{62,32}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "B"),Text(extent = {{-28,-30},{50,-70}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "A"),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0})}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
       ...
       Free = not Contact and not ContactTwo;//initial() or pre(Free) and flange_b.s > flange_a.s and flange_b.s - secondStopDistance < flange_a.s or pre(Contact) and vB-vA>vLeaveContact or pre(ContactTwo) and vA-vB>vLeaveContact;

       Contact = initial() and flange_a.s >= flange_b.s or
                 pre(Free) and flange_a.s > flange_b.s and (abs(vA-vB) < vReachContact or vA > vB) or
                 pre(Contact) and vB-vA < vLeaveContact;

       ContactTwo = initial() and secondStop and flange_b.s - secondStopDistance  >= flange_a.s or
                    pre(Free) and flange_b.s - secondStopDistance  > flange_a.s and (vB-vA > vReachContact or vB > vA) or
                    pre(ContactTwo) and vA-vB < vLeaveContact;

        aRelA = if Contact and aRelA >= 0 and aRelB >= 0 then min((flange_a.f + g * mA) / mA, (flange_b.f + g * mB) / mB) else
                if Contact and aRelA < 0 and aRelB < 0 then (flange_a.f + g * mA) / mA else
                if Contact and aRelA > 0 and aRelB < 0 then 0 else
                if ContactTwo and aRelA > 0 and aRelB > 0 then (flange_a.f + g * mA) / mA else
                if ContactTwo and aRelA < 0 and aRelB < 0 then max((flange_a.f + g * mA) / mA, (flange_b.f + g * mB) / mB) else
                if ContactTwo and aRelA < 0 and aRelB > 0 then 0 else (flange_a.f + g * mA) / mA;

        aRelB = if Contact and aRelA > 0 and aRelB > 0 then (flange_b.f + g * mB) / mB else
                if Contact and aRelA < 0 and aRelB < 0 then max((flange_a.f + g * mA) / mA, (flange_b.f + g * mB) / mB) else
                if Contact and aRelA > 0 and aRelB < 0 then 0 else
                if ContactTwo and aRelA >= 0 and aRelB >= 0 then min((flange_a.f + g * mA) / mA, (flange_b.f + g * mB) / mB) else
                if ContactTwo and aRelA < 0 and aRelB < 0 then (flange_b.f + g * mB) / mB else
                if ContactTwo and aRelA < 0 and aRelB > 0 then 0 else (flange_b.f + g * mB) / mB;
  ...
  when ContactTwo then
    reinit(sB,sA+secondStopDistance);
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-90,80},{90,-80}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{-72,60},{70,-60}}, lineColor = {0,0,0}, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{-46,46},{-4,-46}}, lineColor = {0,0,0}, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-48,-58},{34,-84}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Text(extent = {{-58,12},{24,-14}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "B"),Rectangle(extent = {{-6,10},{100,-10}}, pattern = LinePattern.None, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-32,-58},{50,-84}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "A"),Text(extent = {{-72,12},{10,-14}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Rectangle(extent = {{50,-28},{66,-24}}, pattern = LinePattern.None, lineColor = {0,0,0}, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid),Line(points = {{84,-10},{90,-10}}, pattern = LinePattern.None, smooth = Smooth.None),Rectangle(extent = {{94,-4},{110,0}}, pattern = LinePattern.None, lineColor = {0,0,0}, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{70,10},{90,14}}, pattern = LinePattern.None, lineColor = {0,0,0}, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{94,-4},{110,0}}, pattern = LinePattern.None, lineColor = {0,0,0}, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{70,-14},{90,-10}}, pattern = LinePattern.None, lineColor = {0,0,0}, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid),Line(points = {{84,-10},{90,-10}}, pattern = LinePattern.None, smooth = Smooth.None),Line(points = {{-4,10},{90,10}}, smooth = Smooth.None, color = {0,0,0}),Line(points = {{-4,-10},{90,-10}}, smooth = Smooth.None, color = {0,0,0}),Line(points = {{70,14},{90,14}}, smooth = Smooth.None, color = {0,0,0}),Line(points = {{70,-14},{90,-14}}, smooth = Smooth.None, color = {0,0,0}),Rectangle(extent = {{16,34},{62,30}}, pattern = LinePattern.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Polygon(points = {{16,38},{16,26},{10,32},{16,38}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{60,38},{60,26},{66,32},{60,38}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{22,-84},{22,-96},{28,-90},{22,-84}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-22,-84},{-22,-96},{-28,-90},{-22,-84}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{-22,-88},{24,-92}}, pattern = LinePattern.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0})}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
       ...
       //   STATE EVENTS   //
       Free = not Contact and not ContactTwo or
              pre(Contact) and (abs(deltav) > vLeaveContact or deltaf > 0) or
              pre(ContactTwo) and (abs(deltav) > vLeaveContact or deltaf > 0) or
              pre(Free) and flange_a.s < flange_b.s and flange_a.s > flange_b.s - secondStopDistance;
      ...
      //////////////////////
        ...
        aRelA = if None then (flange_a.f - deltav * vis + mA * g) / mA else
                if Stick then (flange_a.f + flange_b.f + g * (mA + mB)) / (mA + mB) else
                if Contact and aRelA >= 0 and aRelB >= 0 then min((flange_a.f + g * mA) / mA, (flange_b.f + g * mB) / mB) else
                if Contact and aRelA < 0 and aRelB < 0 then (flange_a.f + g * mA) / mA else
                if Contact and aRelA > 0 and aRelB < 0 then 0 else
                if ContactTwo and aRelA > 0 and aRelB > 0 then (flange_a.f + g * mA) / mA else
                if ContactTwo and aRelA < 0 and aRelB < 0 then max((flange_a.f + g * mA) / mA, (flange_b.f + g * mB) / mB) else
                if ContactTwo and aRelA < 0 and aRelB > 0 then 0 else (flange_a.f -Ffric + g * mA) / mA;

        aRelB = if None then (flange_b.f - deltav * vis + mB * g) / mB else
                if Stick then (flange_a.f + flange_b.f + g * (mA + mB)) / (mA + mB) else
                if Contact and aRelA > 0 and aRelB > 0 then (flange_b.f + g * mB) / mB else
                if Contact and aRelA < 0 and aRelB < 0 then max((flange_a.f + g * mA) / mA, (flange_b.f + g * mB) / mB) else
                if Contact and aRelA > 0 and aRelB < 0 then 0 else
                if ContactTwo and aRelA >= 0 and aRelB >= 0 then min((flange_a.f + g * mA) / mA, (flange_b.f + g * mB) / mB) else
                if ContactTwo and aRelA < 0 and aRelB < 0 then (flange_b.f + g * mB) / mB else
                if ContactTwo and aRelA < 0 and aRelB > 0 then 0 else (flange_b.f + Ffric + g * mB) / mB;
  ...
  when ContactTwo then
    reinit(sB,sA+secondStopDistance);
      ...
      ///////////////////////
        annotation(Icon(graphics={  Rectangle(extent = {{-90,80},{90,-80}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-72,60},{-54,50},{-54,60},{-36,50},{-36,60},{-18,50},{-18,60},{0,50},{0,60},{18,50},{18,60},{36,50},{36,60},{54,50},{54,60},{70,50},{70,-60},{52,-50},{52,-60},{34,-50},{34,-60},{16,-50},{16,-60},{-2,-50},{-2,-60},{-20,-50},{-20,-60},{-38,-50},{-38,-60},{-56,-50},{-56,-60},{-72,-50},{-72,60}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{-46,46},{-4,-46}}, lineColor = {0,0,0}, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Text(extent = {{-48,-58},{34,-84}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Text(extent = {{-58,12},{24,-14}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "B"),Text(extent = {{-32,-58},{50,-84}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "A"),Text(extent = {{-72,12},{10,-14}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                    0.5, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid, textString = "m"),Rectangle(extent = {{94,10},{-8,-10}}, pattern = LinePattern.None, fillColor = {175,175,175},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{70,14},{90,10}}, pattern = LinePattern.None, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Rectangle(extent = {{70,-10},{90,-14}}, pattern = LinePattern.None, fillColor = {255,255,255},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Line(points = {{-4,10},{90,10}}, smooth = Smooth.None, color = {0,0,0}),Line(points = {{-4,-10},{90,-10}}, smooth = Smooth.None, color = {0,0,0}),Line(points = {{70,14},{90,14}}, pattern = LinePattern.None, smooth = Smooth.None),Line(points = {{70,-14},{90,-14}}, pattern = LinePattern.None, smooth = Smooth.None),Polygon(points = {{60,38},{60,26},{66,32},{60,38}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{16,38},{16,26},{10,32},{16,38}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{16,34},{62,30}}, pattern = LinePattern.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Polygon(points = {{22,-84},{22,-96},{28,-90},{22,-84}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Polygon(points = {{-22,-84},{-22,-96},{-28,-90},{-22,-84}}, pattern = LinePattern.None, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid),Rectangle(extent = {{-22,-88},{24,-92}}, pattern = LinePattern.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                    FillPattern.Solid, lineColor = {0,0,0}),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0})}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model Velocity "Singal to velocity"
        ...
        Modelica.Blocks.Interfaces.RealInput s_ref
          "Reference position of flange as input signal"                                          annotation(Placement(transformation(extent = {{-126,-20},{-86,20}}, rotation = 0)));
        Modelica.Mechanics.Translational.Interfaces.Flange_b flange
          "Flange of component"                                                           annotation(Placement(transformation(extent = {{90,-10},{110,10}}, rotation = 0)));
      equation
        if unit == "mm/s" then
...
<td><p>Initial implementation and documentation</p></td>
      ...
      package Utilities
       model ForceCombi
          ...
          Modelica.Mechanics.Translational.Interfaces.Flange_b flange_c
       ...
       equation
          ...
          annotation (Icon(graphics={Rectangle(extent={{-100,100},{100,-100}},
                  lineColor={0,0,0}),Polygon(
                          points={{-64,-80},{-64,-32},{-64,-30},{-70,-30},{-60,-20},
                    {-50,-30},{-56,-30},{-56,-80},{-64,-80}},
                          lineColor={0,0,0},
                          smooth=Smooth.None,
                          fillColor={95,95,95},
                fillPattern =                                                                                                   FillPattern.Solid),Polygon(points = {{56,-80},{56,-32},{56,-30},{50,-30},{60,-20},{70,-30},{64,-30},{64,-80},{56,-80}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {95,95,95},
                fillPattern =                                                                                                   FillPattern.Solid),Polygon(points = {{-4,24},{-4,72},{-4,74},{-10,74},{0,84},{10,74},{4,74},{4,24},{-4,24}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {95,95,95},
                fillPattern =                                                                                                   FillPattern.Solid),Text(extent = {{16,-42},{46,-64}}, lineColor = {0,0,0}, fillColor = {95,95,95},
                fillPattern =                                                                                                   FillPattern.Solid, textString = "F2"),Text(extent = {{-46,-42},{-16,-64}}, lineColor = {0,0,0}, fillColor = {95,95,95},
                fillPattern =                                                                                                   FillPattern.Solid, textString = "F1"),Text(extent = {{14,60},{64,38}}, lineColor = {0,0,0}, fillColor = {95,95,95},
                fillPattern =                                                                                                   FillPattern.Solid, textString = "Fges")}));
       end ForceCombi;
  ...
  <caption align=\"bottom\"><b>Figure 1: </b>Differences between DC_Mechlib and Simstercomponents</caption>
    ...
    package Rotatory
      ...
      equation
        ...
        annotation(Diagram(graphics), Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Rectangle(extent = {{-50,70},{50,-70}}, lineColor = {0,0,0}),Text(extent={{
                    -40,52},{42,-40}},                                                                                                    lineColor = {0,0,0}, textStyle = {TextStyle.Bold}, textString = "?")}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Ellipse(extent = {{-60,60},{60,-60}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Ellipse(extent = {{-6,6},{6,-6}}, lineColor = {0,0,0}, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid),Line(points = {{-60,0},{-60,-100}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{60,0},{60,-100}}, color = {0,0,0}, smooth = Smooth.None)}), Diagram(graphics), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(choices(choice = "rad", choice = "grad"), Icon(graphics={  Polygon(points = {{0,60},{-60,-40},{60,-40},{0,60}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {135,135,135},
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-40,16},{-20,-24}}, lineColor = {0,0,0},
                  fillPattern =                                                                                 FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{-40,96},{-20,16}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{20,76},{40,35}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{20,36},{40,-44}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{40,10},{100,-10}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{-20,66},{20,46}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{-100,10},{-40,-10}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Polygon(points = {{-60,-68},{-60,-72},{50,-72},{50,-80},{60,-70},{50,-60},{50,-68},{-60,-68}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0})}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Diagram(graphics), Icon(graphics={  Rectangle(extent = {{-40,16},{-20,-24}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{-40,96},{-20,16}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{20,76},{40,35}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{20,36},{40,-44}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{40,10},{100,-10}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{-20,66},{20,46}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{-100,10},{-40,-10}}, lineColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.HorizontalCylinder, fillColor = {192,192,192}),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Polygon(points = {{-60,-68},{-60,-72},{50,-72},{50,-80},{60,-70},{50,-60},{50,-68},{-60,-68}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid)}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Ellipse(extent = {{-60,60},{60,-60}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Line(points = {{-80,0},{-80,10},{-78,26},{-70,42},{-56,58},{-38,70},{-20,78},{0,80}}, color = {0,0,0}, smooth = Smooth.None),Polygon(points = {{-80,-20},{-86,0},{-74,0},{-80,-20}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid),Text(extent = {{-54,48},{52,-48}}, lineColor = {0,0,0}, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid, textString = "J")}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        Contact_up = initial() and flange_a.phi >= upcont or
                     pre(Free) and flange_a.phi > upcont and omega > wReachContact;
        Contact_down = initial() and flange_a.phi <= lowcont or
                       pre(Free) and lowcont > flange_a.phi and -omega > wReachContact;
        Free = initial() or pre(Contact_up) and (abs(omega) > wLeaveContact or deltaM < 0) or
               pre(Contact_down) and (abs(omega) > wLeaveContact or deltaM > 0) or
               pre(Free) and flange_a.phi < upcont or flange_a.phi > lowcont;
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Ellipse(extent = {{-60,60},{60,-60}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Line(points = {{-80,0},{-80,10},{-78,26},{-70,42},{-56,58},{-38,70},{-20,78},{0,80}}, color = {0,0,0}, smooth = Smooth.None),Polygon(points = {{-80,-20},{-86,0},{-74,0},{-80,-20}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid),Text(extent = {{-54,48},{52,-48}}, lineColor = {0,0,0}, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid, textString = "J"),Polygon(points = {{-48,-36},{-36,-48},{-52,-64},{-64,-52},{-48,-36}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Polygon(points = {{0,-64},{-16,-90},{16,-90},{0,-64}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Line(points = {{-14,-90},{-18,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{10,-90},{6,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{4,-90},{0,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-2,-90},{-6,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-8,-90},{-12,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{16,-90},{12,-96}}, color = {0,0,0}, smooth = Smooth.None)}), Documentation(info = "<HTML>
...
<table border=0 cellspacing=0 cellpadding=2>
  <tr>
    <td>
       <img src=\"W:/10_ETI22/__Kollegen/_SvenBätzing/DC_Mechlib/images/statesendstoprot.jpg\" width=\"800\" align=\"center\">
    </td>
  </tr>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model InertiaFriction
        ...
        parameter SI.Torque Mslip = 5 "sliding friction" annotation(Dialog(group = "Friction"));
        parameter Real vis(unit = "N.s.m/rad") = 0 "viscous friction value"              annotation(Dialog(group = "Friction"));
        parameter SI.AngularVelocity wh(min = 1e-11) = 0.000001
          "static velocity limit"                                                       annotation(Dialog(group = "Friction"));
        parameter SI.Angle phi_init = 0 annotation(Dialog(group = "Initialization"));
        parameter SI.AngularVelocity omega_init = 0 annotation(Dialog(group = "Initialization"));
        parameter Boolean initialize_phi = true annotation(Dialog(group = "Initialization"));
      ...
      equation
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Ellipse(extent = {{-60,60},{60,-60}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Line(points = {{-80,0},{-80,10},{-78,26},{-70,42},{-56,58},{-38,70},{-20,78},{0,80}}, color = {0,0,0}, smooth = Smooth.None),Polygon(points = {{-80,-20},{-86,0},{-74,0},{-80,-20}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid),Text(extent = {{-54,48},{52,-48}}, lineColor = {0,0,0}, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid, textString = "J"),Polygon(points = {{32,56},{42,52},{52,44},{60,32},{66,14},{66,-4},{64,-18},{58,-36},{50,-48},{38,-56},{58,-56},{66,-48},{72,-38},{78,-20},{80,-4},{80,10},{78,24},{72,38},{62,52},{56,56},{32,56}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid)}), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model InertiaFrictionEndstop
        ...
        parameter SI.Torque Mstick = 10 "static friction" annotation(Dialog(group = "Friction"));
        parameter SI.Torque Mslip = 5 "sliding friction" annotation(Dialog(group = "Friction"));
        parameter Real vis(unit = "N.s.m/rad") = 0
          "viscous friction value in Nsm/grad "                                          annotation(Dialog(group = "Friction"));
        parameter SI.AngularVelocity wh(min = 1e-11) = 0.000001
          "static velocity limit"                                                       annotation(Dialog(group = "Friction"));
        parameter SI.Angle lowcont = -pi "Lower contact" annotation(Dialog(group = "Hard stop"));
        parameter SI.Angle upcont = pi "Upper contact" annotation(Dialog(group = "Hard stop"));
      ...
      //                      //
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Ellipse(extent = {{-60,60},{60,-60}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  ...
                  fillPattern =                                                                                                   FillPattern.Solid, textString = "J"),Polygon(points = {{-48,-36},{-36,-48},{-52,-64},{-64,-52},{-48,-36}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Polygon(points = {{0,-64},{-16,-90},{16,-90},{0,-64}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Line(points = {{-14,-90},{-18,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{10,-90},{6,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{4,-90},{0,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-2,-90},{-6,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-8,-90},{-12,-96}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{16,-90},{12,-96}}, color = {0,0,0}, smooth = Smooth.None),Polygon(points = {{32,56},{42,52},{52,44},{60,32},{66,14},{66,-4},{64,-18},{58,-36},{50,-48},{38,-56},{58,-56},{66,-48},{72,-38},{78,-20},{80,-4},{80,10},{78,24},{72,38},{62,52},{56,56},{32,56}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {135,135,135},
...
<td><p>Initial implementation and documentation</p></td>
      ...
      model RackandPin "rotatory to linear"
        ...
        Modelica.Mechanics.Rotational.Components.IdealGearR2T idealGearR2T(ratio=1/
              Radius)                                                                               annotation(Placement(transformation(extent = {{-10,-10},{10,10}})));
      equation
        ...
        annotation(Diagram(graphics), Icon(graphics={  Ellipse(extent = {{60,-60},{-60,60}}, lineColor = {0,0,0}),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Ellipse(extent = {{-8,8},{8,-8}}, lineColor = {0,0,0}, fillColor = {135,135,135},
                  fillPattern =                                                                                                   FillPattern.Solid),Rectangle(extent = {{-80,-60},{80,-70}}, lineColor = {0,0,0}),Line(points = {{-86,-72},{88,-72}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-80,-72},{-88,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{80,-72},{72,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{60,-72},{52,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{40,-72},{32,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{20,-72},{12,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{0,-72},{-8,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-20,-72},{-28,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-40,-72},{-48,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-60,-72},{-68,-84}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-20,-20},{20,-20}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{0,-8},{-8,-20},{-16,-28}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{0,-8},{8,-20},{0,-28}}, color = {0,0,0}, smooth = Smooth.None)}), Documentation(info = "<HTML>
...
<td><p>Further implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(choices(choice = "N", choice = "kN", choice = "dyn", choice = "kp", choice = "pdl", choice = "lbf", choice = "yd"), Icon(graphics={  Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Line(points = {{-84,40},{-58,40}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Text(extent = {{-24,76},{24,12}}, lineColor = {0,0,0},
                  lineThickness =                                                                                                   0.5,
                  fillPattern =                                                                                                   FillPattern.Solid, textString = "M"),Line(points = {{58,40},{82,40}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Line(points = {{70,50},{70,26}}, color = {0,0,0}, thickness = 0.5, smooth = Smooth.None),Polygon(points = {{10,2},{10,-2},{70,-2},{70,-10},{80,0},{70,10},{70,2},{10,2}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid),Polygon(points = {{-10,2},{-10,-2},{-70,-2},{-70,-10},{-80,0},{-70,10},{-70,2},{-10,2}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid)}), Diagram(graphics), Documentation(info = "<HTML>
...
<td><p>Initial implementation and documentation</p></td>
      ...
      equation
        ...
        annotation(Icon(graphics={  Rectangle(extent = {{-100,70},{-96,-70}}, lineColor = {0,0,0}),Rectangle(extent = {{96,70},{100,-70}}, lineColor = {0,0,0}),Rectangle(extent = {{-96,40},{96,-40}}, lineColor = {0,0,0}),Line(points = {{-96,-18},{-88,-40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-96,28},{-70,-42}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-50,-40},{-80,40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{50,-40},{20,40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{30,-40},{0,40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{10,-40},{-20,40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-10,-40},{-40,40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{-30,-40},{-60,40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{90,-40},{60,40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{70,-40},{40,40}}, color = {0,0,0}, smooth = Smooth.None),Line(points = {{80,40},{96,-4}}, color = {0,0,0}, smooth = Smooth.None),Rectangle(extent = {{-100,100},{100,-100}}, lineColor = {0,0,0}),Polygon(points = {{-60,72},{-60,68},{50,68},{50,60},{60,70},{50,80},{50,72},{-60,72}}, lineColor = {0,0,0}, smooth = Smooth.None, fillColor = {0,0,0},
                  fillPattern =                                                                                                   FillPattern.Solid)}), Diagram(graphics), Documentation(info = "<HTML>
  ...
  package testcases
    package Linear
      ...
      model massEndstop
        ...
        Components.Linear.MassEndstop massEndstop(
          lowlim=0,
          uplim=1,
          restitutionCoefficient=25,
          g=-9.81,
          initialize_s=true,
          initialize_v=true)
      ...
      equation
        ...
        connect(force.flange, massEndstop.flange_a) annotation (Line(
            points={{-2,0},{20,0}},
            color={0,127,0},
            smooth=Smooth.None));
      ...
      model massFriction
        ...
        Components.Linear.MassFriction massFriction(initialize_s=true,
            initialize_v=true)
          annotation (Placement(transformation(extent={{8,-10},{28,10}})));
      equation
        connect(timeTable.y,force.f) annotation(Line(points = {{-53,0},{-28,0}}, color = {0,0,127}, smooth = Smooth.None));
        connect(force.flange, massFriction.flange_a) annotation (Line(
            points={{-6,0},{8,0}},
            color={0,127,0},
            smooth=Smooth.None));
        annotation(Diagram(graphics));
      ...
      model massFriction2
        Components.Linear.MassFriction massFriction(
          initialize_s=true,
          initialize_v=true,
          v_init=2)
      ...
      model massFrictionEndstop
        Components.Linear.MassFrictionEndstop massFrictionEndstop(
          restitutionCoefficient=70,
          initialize_s=true,
          initialize_v=true,
          s_init=0.5,
          v_init=-5)
      ...
      model massFrictionEndstop2
        ...
        Components.Linear.MassFrictionEndstop massFrictionEndstop(initialize_s=
              true, initialize_v=true)
          annotation (Placement(transformation(extent={{20,-10},{40,10}})));
      equation
        connect(pulse.y,force.f) annotation(Line(points = {{-53,0},{-28,0}}, color = {0,0,127}, smooth = Smooth.None));
        connect(force.flange, massFrictionEndstop.flange_a) annotation (Line(
            points={{-6,0},{20,0}},
            color={0,127,0},
            smooth=Smooth.None));
        annotation(Diagram(graphics));
      ...
      model TwoMassFriction
        Components.Linear.TwoMassFriction twoMassFriction(g = 0, mA = 10, mB = 10, Fc = 2, vh(displayUnit = "m/s") = 0.000001,
          initialize_sA=true,
          initialize_sB=true,
          initialize_vA=true,
          initialize_vB=true,
          Stick(fixed=true))                                                                                                   annotation(Placement(transformation(extent={{0,-10},
                  {20,10}})));
        ...
        Modelica.Blocks.Sources.Step step(            startTime = 0.5,
          height=92,
          offset=8)                                                                 annotation(Placement(transformation(extent = {{-80,-10},{-60,10}})));
      equation
        connect(force.flange,twoMassFriction.flange_a) annotation(Line(points={{-18,0},
                {0,0}},                                                                          color = {0,127,0}, thickness = 0.5, smooth = Smooth.None));
      ...
      model TwoMassEndstop
        ...
        Modelica.Mechanics.Translational.Sources.Force force annotation(Placement(transformation(extent={{-40,-10},
                  {-20,10}})));
        Components.Linear.TwoMassEndstop twoMassEndstop1(
          restitutionCoefficient=30,
          g=0,
          secondStop=true,
          initialize_sA=true,
          initialize_sB=true,
      ...
      equation
        ...
        connect(twoMassEndstop1.flange_b, force.flange) annotation (Line(
            points={{0,30},{14,30},{14,0},{-20,0}},
            color={0,127,0},
            smooth=Smooth.None));
        annotation(Diagram(graphics));
      end TwoMassEndstop;
      ...
      model TwoMassFrictionEndstop
        Modelica.Mechanics.Translational.Sources.Force force annotation(Placement(transformation(extent={{-44,-10},
                  {-24,10}})));
        Modelica.Blocks.Sources.TimeTable timeTable(table=[0,0; 0.5,0; 0.51,11;
              2,11; 2.01,0; 5,0])                                                                annotation(Placement(transformation(extent = {{-86,-10},{-66,10}})));
        Components.Linear.TwoMassFrictionEndstop twoMassFrictionEndstop1(
          mA=100,
          mB=5,
          g=0,
          secondStop=true)
      ...
      equation
        ...
        connect(twoMassFrictionEndstop1.flange_b, force.flange) annotation (
            Line(
            points={{-12,0},{-24,0}},
            color={0,127,0},
            smooth=Smooth.None));
      ...
      model TwoMassFriction2
        Components.Linear.TwoMassFriction twoMassFriction(g = 0, mA = 1, mB = 1, vis = 1,
          initialize_sA=true,
          initialize_sB=true,
          initialize_vA=true,
          initialize_vB=true)                                                             annotation(Placement(transformation(extent = {{4,-10},{24,10}})));
        Modelica.Mechanics.Translational.Sources.Force force annotation(Placement(transformation(extent={{-40,-10},
                  {-20,10}})));
      ...
      equation
        connect(force.flange,twoMassFriction.flange_a) annotation(Line(points={{-20,0},
                {4,0}},                                                                          color = {0,127,0}, thickness = 0.5, smooth = Smooth.None));
      ...
      model TwoMassEndstopInit
        Components.Linear.TwoMassEndstop twoMassEndstop(
          mA=1000,
          mB=1,
          restitutionCoefficient=100,
          g=0,
          secondStop=true,
          initialize_sA=true,
          initialize_sB=true,
      ...
      model massEndstoptest
        DC_Mechlib_SB.Components.Linear.MassEndstopNOTUSED
                                                    massEndstop(m = 50, g = 0, restitutionCoefficient = 90, lowlim = 0, uplim = 0.2) annotation(Placement(transformation(extent = {{22,-10},{42,10}})));
        Modelica.Mechanics.Translational.Sources.Force force annotation(Placement(transformation(extent = {{-22,-10},{-2,10}})));
      ...
      model test
        ...
        Modelica.Blocks.Sources.Step step(height=15, startTime=0.5)
          annotation (Placement(transformation(extent={{-94,-10},{-74,10}})));
        Components.Linear.DryFricStribeck dryFricStribeck
          annotation (Placement(transformation(extent={{-38,20},{-18,40}})));
      equation
        connect(mass.flange_a, force.flange) annotation (Line(
            points={{-8,0},{-34,0}},
            color={0,127,0},
            smooth=Smooth.None));
        connect(force.f, step.y) annotation (Line(
            points={{-56,0},{-73,0}},
            color={0,0,127},
            smooth=Smooth.None));
        connect(dryFricStribeck.flange_a, mass.flange_a) annotation (Line(
            points={{-18,30},{-18,0},{-8,0}},
            color={0,127,0},
            smooth=Smooth.None));
      ...
      model test2
        Modelica.Blocks.Sources.Ramp ramp(duration=2, height=500)
          annotation (Placement(transformation(extent={{-70,38},{-50,58}})));
        Modelica.Mechanics.Translational.Sources.Force force
          annotation (Placement(transformation(extent={{18,20},{38,40}})));
        Components.Linear.TwoMassFrictionEndstop twoMassFrictionEndstop(
          mA=100,
          mB=5,
          g=0,
          secondStop=true)
      ...
      equation
        connect(force.flange, twoMassFrictionEndstop.flange_b) annotation (Line(
            points={{38,30},{40,30},{40,0},{20,0}},
            color={0,127,0},
            smooth=Smooth.None));
        connect(ramp.y, force.f) annotation (Line(
            points={{-49,48},{-16,48},{-16,30},{16,30}},
            color={0,0,127},
            smooth=Smooth.None));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                  -100},{100,100}}),        graphics));
    ...
    package Rotatory
      ...
      model InertiaFrictionEndstop
        Components.Rotatory.InertiaFrictionEndstop inertiaFrictionEndstop(vis = 0.1, restitutionCoefficient = 25,                                                      initialize_phi = true, initialize_omega = true, J = 10,
          phi_init=3.1414181206646,
          omega_init(displayUnit="deg/s") = -6.2831853071796)                                                                                                     annotation(Placement(transformation(extent = {{-12,-10},{8,10}})));
      end InertiaFrictionEndstop;
      ...
      model CableReel
        ...
        Components.Rotatory.CableReel cableReel(
          wh=0.001,
          Mslip=2,
          Mstick=2)
          annotation (Placement(transformation(extent={{20,-10},{40,10}})));
      equation
        ...
        connect(forceVariable.flange_a, cableReel.flange_a) annotation (Line(
            points={{10,-40},{18,-40},{18,-10},{24,-10}},
            color={0,127,0},
            smooth=Smooth.None));
        connect(torqueConstant.flange_b, cableReel.flange_b) annotation (Line(
            points={{10,40},{20,40},{20,10},{30,10}},
            color={0,0,0},
            smooth=Smooth.None));
        annotation(Diagram(graphics));
      end CableReel;
      ...
      model test
        Components.Linear.Clamp clamp
          annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
        Components.Linear.ForceConstant forceConstant(F=5)
          annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));
        Components.Linear.MassFriction massFriction(v_init=-5)
          annotation (Placement(transformation(extent={{2,-10},{22,10}})));
      equation
        connect(clamp.flange, forceConstant.flange_a) annotation (Line(
            points={{-60,0},{-40,0}},
            color={0,127,0},
            smooth=Smooth.None));
        connect(forceConstant.flange_b, massFriction.flange_a) annotation (Line(
            points={{-20,0},{2,0}},
            color={0,127,0},
            smooth=Smooth.None));
        annotation (Diagram(graphics));

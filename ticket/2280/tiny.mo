...
package tiny
  model tiny
    ...
    getUPeak getUPeak1 annotation (Placement(transformation(
          ...
          origin={72,16})));
  equation
    connect(resistor.pin_p, U.pin_p) annotation (Line(points={{-24,40},{-80,40},
            {-80,26.9565},{-80,26.9565}}));
    connect(resistor.pin_n, getUPeak1.positivePin) annotation (Line(points={{-4,
            40},{72.1739,40},{72.1739,25.2174},{72.1739,25.2174}}));

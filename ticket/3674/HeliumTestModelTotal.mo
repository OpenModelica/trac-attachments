package HelmholtzMedia  "Data and models of real pure fluids (liquid, two-phase and gas)" 
  ...
  package Interfaces  
    partial package PartialHelmholtzMedium  
      ...
      extends Modelica.Media.Interfaces.PartialTwoPhaseMedium(onePhase = false, singleState = false, smoothModel = true, DipoleMoment(min = 0, max = 5), AbsolutePressure(min = Modelica.Constants.small, max = 1e12), SpecificEntropy(min = -Modelica.Constants.inf, max = Modelica.Constants.inf), ThermoStates = Modelica.Media.Interfaces.Choices.IndependentVariables.ph);
      ...
      package EoS  
        ...
        function dpdT  "returns pressure derivative (dp/dd)@T=const" 
          ...
          output .HelmholtzMedia.Interfaces.Types.DerPressureByDensity dpdT;
        algorithm
        ...
        function dpTd  "returns pressure derivative (dp/dT)@d=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerPressureByTemperature dpTd;
        algorithm
        ...
        function dsdT  "returns entropy derivative (ds/dd)@T=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerEntropyByDensity dsdT;
        algorithm
        ...
        function dsTd  "returns entropy derivative (ds/dT)@d=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerEntropyByTemperature dsTd;
        algorithm
        ...
        function dudT  "returns internal energy derivative (du/dd)@T=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerEnergyByDensity dudT;
        algorithm
        ...
        function duTd  "returns internal energy derivative (du/dT)@d=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerEnergyByTemperature duTd;
        algorithm
        ...
        function dhdT  "returns enthalpy derivative (dh/dd)@T=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerEnthalpyByDensity dhdT;
        algorithm
        ...
        function dhTd  "returns enthalpy derivative (dh/dT)@d=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerEnthalpyByTemperature dhTd;
        algorithm
        ...
        function dgdT  "returns Gibbs energy derivative (dg/dd)@T=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerEnergyByDensity dgdT;
        algorithm
        ...
        function dgTd  "returns Gibbs energy derivative (dg/dT)@d=const" 
          input EoS.HelmholtzDerivs f;
          output .HelmholtzMedia.Interfaces.Types.DerEnergyByTemperature dgTd;
        algorithm
      ...
      function setState_dTX1p  "Return thermodynamic single-phase state as function of (d, T)" 
      ...
      protected
        ...
        .HelmholtzMedia.Interfaces.Types.DerPressureByDensity dpdT "(dp/dd)@T=const";
      ...
      protected
        ...
        AbsolutePressure RES_max;
        AbsolutePressure RES_p;
        .HelmholtzMedia.Interfaces.Types.DerPressureByTemperature dpTd "(dp/dT)@d=const";
        Real gamma(min = 0.1, max = 1) = 1 "convergence speed, default=1";
      ...
      protected
        ...
        SaturationProperties sat;
        MassFraction x "vapour quality";
        .HelmholtzMedia.Interfaces.Types.DerPressureByTemperature dpT;
        EoS.HelmholtzDerivs fl;
        EoS.HelmholtzDerivs fv;
        .HelmholtzMedia.Interfaces.Types.DerEnergyByTemperature duT_liq;
        .HelmholtzMedia.Interfaces.Types.DerEnergyByTemperature duT_vap;
        DerDensityByTemperature ddT_liq;
        DerDensityByTemperature ddT_vap;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByTemperature dvT_liq;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByTemperature dvT_vap;
        .HelmholtzMedia.Interfaces.Types.DerFractionByTemperature dxTv;
      algorithm
        if state.phase == 1 then
          f := EoS.setHelmholtzDerivsSecond(T = state.T, d = state.d, phase = 1);
          cv := EoS.duTd(f);
      ...
      protected
        ...
        EoS.HelmholtzDerivs fl;
        EoS.HelmholtzDerivs fv;
        .HelmholtzMedia.Interfaces.Types.DerEntropyByPressure dsp_liq;
        .HelmholtzMedia.Interfaces.Types.DerEntropyByPressure dsp_vap;
        DerDensityByPressure ddp_liq;
        DerDensityByPressure ddp_vap;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByPressure dvp_liq;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByPressure dvp_vap;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByPressure dvps;
        .HelmholtzMedia.Interfaces.Types.DerFractionByPressure dxps;
      algorithm
        if state.phase == 1 then
          f := EoS.setHelmholtzDerivsSecond(T = state.T, d = state.d, phase = 1);
      ...
      function saturationPressure_derT_sat  "returns (dp/dT)@sat" 
        input SaturationProperties sat;
        output .HelmholtzMedia.Interfaces.Types.DerPressureByTemperature dpT;
      algorithm
      ...
      protected
        ...
        .HelmholtzMedia.Interfaces.Types.DerEnthalpyByTemperature dhTp = EoS.dhTd(f) - EoS.dhdT(f) * EoS.dpTd(f) / EoS.dpdT(f);
        DerTemperatureByPressure dTp = saturationTemperature_derp(p = sat.psat);
      algorithm
        dhldp := dhpT + dhTp * dTp;
        annotation(Inline = true); 
      ...
      protected
        ...
        .HelmholtzMedia.Interfaces.Types.DerVolumeByPressure dvp_liq;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByPressure dvp_vap;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByPressure dvph;
        .HelmholtzMedia.Interfaces.Types.DerFractionByPressure dxph;
      algorithm
        if state.phase == 1 then
          f := EoS.setHelmholtzDerivsSecond(T = state.T, d = state.d, phase = state.phase);
      ...
      protected
        ...
        EoS.HelmholtzDerivs fl;
        EoS.HelmholtzDerivs fv;
        .HelmholtzMedia.Interfaces.Types.DerEnthalpyByTemperature dhT_liq;
        .HelmholtzMedia.Interfaces.Types.DerEnthalpyByTemperature dhT_vap;
        DerDensityByTemperature ddT_liq;
        DerDensityByTemperature ddT_vap;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByTemperature dvT_liq;
        .HelmholtzMedia.Interfaces.Types.DerVolumeByTemperature dvT_vap;

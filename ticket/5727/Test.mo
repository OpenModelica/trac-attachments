package FlexiCaL  
  ...
  package FeedWater  "Components for feed water train modelling" 
    package FWPHs_Accurate  "FWPH Sized Model (and tests) of the FWPH_11, FWPH_12, FWPH_13, FWPH_14, FWPH_15, Base FWPH Model" 
      package Sized_FWPHs  
        model FWPH_14  
          extends FlexiCaL.Components.FWPH_Base(CSmin_PID = 0.1, wnf_FW = 0.1, wnf_STEAM = 0.02, wnf_DRAIN = 0.02, Rf = 0.0000581, r_tube_int = 0.00612, r_tube_ext = 0.009525, L_sub = 7.5, L_des = 8, N_tubes = 1508, L_tot = 25.2, r_shell_int = 1.155, Mass_dry_tube = 53180, p_start_cond = pnom_out_STEAM, U_des = 302.5, U_cond = 3023, U_sub = 1332.1, wnom_FW = 348.4, wnom_STEAM = 14.05, wnom_DRAIN = 83.14, Tin_DRAIN_nom = 493.05, pnom_out_valve = 950000, pnom_out_FW_des = 32227000, Toutlet_nom_FW_des = 488.05, Toutlet_nom_FW_cond = 483.15, pnom_FW_sub = 32308000, Tinlet_nom_FW_sub = 458.85, Toutlet_nom_FW_sub = 464.15, pnom_steam = 2012000, Tinlet_nom_STEAM = 700.85, Toutlet_nom_STEAM = 486.25, Tinlet_nom_DRAIN = 485.05, Toutlet_nom_DRAIN = 463.85);
        end FWPH_14;

        model FWPH_13  
          extends FlexiCaL.Components.FWPH_Base(wnf_FW = 0.1, wnf_STEAM = 0.02, wnf_DRAIN = 0.02, Rf = 0.0000581, r_tube_int = 0.00692, r_tube_ext = 0.01111, L_des = 8.7, L_sub = 8, N_tubes = 1223, Mass_dry_tube = 65020, wnom_STEAM = 13.97, r_shell_int = 1.215, L_tot = 26.86, U_des = 244.7, U_cond = 2774.6, U_sub = 1125.1, wnom_FW = 348.4, wnom_DRAIN = 69.09, Tin_DRAIN_nom = 520.15, pnom_out_valve = 2002000, pnom_out_FW_des = 32150000, Toutlet_nom_FW_des = 515.15, Toutlet_nom_FW_cond = 509.15, pnom_FW_sub = 32220000, Tinlet_nom_FW_sub = 487.95, Toutlet_nom_FW_sub = 492.15, pnom_steam = 3303000, Tinlet_nom_STEAM = 773.25, Toutlet_nom_STEAM = 513.15, Tinlet_nom_DRAIN = 511.15, Toutlet_nom_DRAIN = 492.95);
        end FWPH_13;

        model FWPH_12  
          extends FlexiCaL.Components.FWPH_Base(wnf_FW = 0.1, wnf_STEAM = 0.02, wnf_DRAIN = 0.02, Rf = 0.0000581, r_tube_int = 0.00692, r_tube_ext = 0.01111, L_des = 9.2, L_sub = 8, N_tubes = 1278, r_shell_int = 1.24, U_des = 384.1, U_cond = 2761.7, U_sub = 1017.7, L_tot = 28.4, Mass_dry_tube = 71282, wnom_FW = 348.4, wnom_STEAM = 23.92, wnom_DRAIN = 55.12, Tin_DRAIN_nom = 551.45, pnom_out_valve = 3313000, pnom_out_FW_des = 32070000, Toutlet_nom_FW_des = 546.45, Toutlet_nom_FW_cond = 543.65, pnom_FW_sub = 32156000, Tinlet_nom_FW_sub = 515.15, Toutlet_nom_FW_sub = 518.65, pnom_steam = 5818000, Tinlet_nom_STEAM = 601.65, Toutlet_nom_STEAM = 547.15, Tinlet_nom_DRAIN = 546.15, Toutlet_nom_DRAIN = 520.15);
        end FWPH_12;
      end Sized_FWPHs;
    end FWPHs_Accurate;
    ...
    package Tests  
      package Tests_FWPHs_Accurate  
        package Tests_with_turbine  
          model Test_FWPH_3Turbine_Boundaries  
            replaceable package Medium = Modelica.Media.Water.WaterIF97_ph constrainedby Modelica.Media.Interfaces.PartialMedium;
            parameter Modelica.SIunits.PerUnit ParArc1 = 1 "Partial Arc Value";
            parameter Modelica.SIunits.AbsolutePressure pnom_turbine1 "Turbine Nominal Pressure";
            parameter Modelica.SIunits.AbsolutePressure pout_nom1 "Nominal Turbine Outlet Pressure";
            parameter Modelica.SIunits.MassFlowRate wnom_turbine1 "Nominal Turbine Mass Flow Rate";
            parameter Modelica.SIunits.MassFlowRate w_nom_bleeding1 "Nominal Bleeding from Turbine Mass Flow Rate";
            parameter Modelica.SIunits.PerUnit eta_iso_nom_turbine1 = 0.92 "Nominal isentropic efficiency";
            final parameter Modelica.SIunits.Density rho_nom_in1 = Medium.density(Medium.setState_ph(pnom_turbine1, h0_inlet1)) "Nominal Inlet Density";
            parameter Modelica.SIunits.Area Kt1 = wnom_turbine1 * sqrt(sqrt((1 - (pout_nom1 / pnom_turbine1) ^ 2) ^ 2 + 0.01 ^ 2)) / (ParArc1 * sqrt(pnom_turbine1 * rho_nom_in1) * (1 - (pout_nom1 / pnom_turbine1) ^ 2)) "Kt coefficient of Stodola's law";
            parameter Modelica.SIunits.Temperature T_inlet1 "Nominal inlet turbine temperature";
            parameter Modelica.SIunits.Temperature T_outlet1 "Nominal outlet turbine temperature";
            parameter Modelica.SIunits.SpecificEnthalpy h0_inlet1 "Nominal Inlet Turbine SPecific Enthalpy";
            parameter Modelica.SIunits.SpecificEnthalpy h0_outlet1 "Nominal Outlet Turbine SPecific Enthalpy";
            parameter Modelica.SIunits.Power mechPower_nom1 "Nominal Mechanical Power";
            final parameter Real eta_mech_turbine1 = mechPower_nom1 / (wnom_turbine1 * (h0_inlet1 - h0_outlet1)) "Mechanical efficiency";
            parameter Modelica.SIunits.PerUnit theta_nom_valve1 = 0.5 "Nominal valve opening";
            parameter Modelica.SIunits.PerUnit ramp_height1 = 0 "";
            parameter Modelica.SIunits.Time ramp_duration1 = 0.0 "";
            parameter Modelica.SIunits.Time ramp_start_time1 = 0 "";
            parameter Modelica.SIunits.Density rho_nom_valve1 "";
            final parameter Modelica.SIunits.PressureDifference dp_turbine1 = pout_nom1 - po_STEAM1 "";
            parameter Modelica.SIunits.AbsolutePressure po_STEAM1 "Boundary condition for inlet STEAM in the FWPH";
            parameter Modelica.SIunits.PerUnit ParArc2 = 1 "Partial Arc Value";
            parameter Modelica.SIunits.AbsolutePressure pnom_turbine2 "Turbine Nominal Pressure";
            parameter Modelica.SIunits.AbsolutePressure pout_nom2 "Nominal Turbine Outlet Pressure";
            parameter Modelica.SIunits.MassFlowRate wnom_turbine2 "Nominal Turbine Mass Flow Rate";
            parameter Modelica.SIunits.MassFlowRate w_nom_bleeding2 "Nominal Bleeding from Turbine Mass Flow Rate";
            parameter Modelica.SIunits.PerUnit eta_iso_nom_turbine2 = 0.92 "Nominal isentropic efficiency";
            final parameter Modelica.SIunits.Density rho_nom_in2 = Medium.density(Medium.setState_ph(pnom_turbine2, h0_inlet2)) "Nominal Inlet Density";
            parameter Modelica.SIunits.Area Kt2 = wnom_turbine2 * sqrt(sqrt((1 - (pout_nom2 / pnom_turbine2) ^ 2) ^ 2 + 0.01 ^ 2)) / (ParArc2 * sqrt(pnom_turbine2 * rho_nom_in2) * (1 - (pout_nom2 / pnom_turbine2) ^ 2)) "Kt coefficient of Stodola's law";
            parameter Modelica.SIunits.Temperature T_inlet2 "Nominal inlet turbine temperature";
            parameter Modelica.SIunits.Temperature T_outlet2 "Nominal outlet turbine temperature";
            parameter Modelica.SIunits.SpecificEnthalpy h0_inlet2 "Nominal Inlet Turbine SPecific Enthalpy";
            parameter Modelica.SIunits.SpecificEnthalpy h0_outlet2 "Nominal Outlet Turbine SPecific Enthalpy";
            parameter Modelica.SIunits.Power mechPower_nom2 "Nominal Mechanical Power";
            final parameter Real eta_mech_turbine2 = mechPower_nom2 / (wnom_turbine2 * (h0_inlet2 - h0_outlet2)) "Mechanical efficiency";
            parameter Modelica.SIunits.PerUnit theta_nom_valve2 = 0.5 "Nominal valve opening";
            parameter Modelica.SIunits.PerUnit ramp_height2 = 0 "";
            parameter Modelica.SIunits.Time ramp_duration2 = 0.0 "";
            parameter Modelica.SIunits.Time ramp_start_time2 = 0 "";
            parameter Modelica.SIunits.Density rho_nom_valve2 "";
            final parameter Modelica.SIunits.PressureDifference dp_turbine2 = pout_nom2 - po_STEAM2 "";
            parameter Modelica.SIunits.AbsolutePressure po_STEAM2 "Boundary condition for inlet STEAM in the FWPH";
            parameter Modelica.SIunits.PerUnit ParArc3 = 1 "Partial Arc Value";
            parameter Modelica.SIunits.AbsolutePressure pnom_turbine3 "Turbine Nominal Pressure";
            parameter Modelica.SIunits.AbsolutePressure pout_nom3 "Nominal Turbine Outlet Pressure";
            parameter Modelica.SIunits.MassFlowRate wnom_turbine3 "Nominal Turbine Mass Flow Rate";
            parameter Modelica.SIunits.MassFlowRate w_nom_bleeding3 "Nominal Bleeding from Turbine Mass Flow Rate";
            parameter Modelica.SIunits.PerUnit eta_iso_nom_turbine3 = 0.92 "Nominal isentropic efficiency";
            final parameter Modelica.SIunits.Density rho_nom_in3 = Medium.density(Medium.setState_ph(pnom_turbine3, h0_inlet3)) "Nominal Inlet Density";
            parameter Modelica.SIunits.Area Kt3 = wnom_turbine3 * sqrt(sqrt((1 - (pout_nom3 / pnom_turbine3) ^ 2) ^ 2 + 0.01 ^ 2)) / (ParArc3 * sqrt(pnom_turbine3 * rho_nom_in3) * (1 - (pout_nom3 / pnom_turbine3) ^ 2)) "Kt coefficient of Stodola's law";
            parameter Modelica.SIunits.Temperature T_inlet3 "Nominal inlet turbine temperature";
            parameter Modelica.SIunits.Temperature T_outlet3 "Nominal outlet turbine temperature";
            parameter Modelica.SIunits.SpecificEnthalpy h0_inlet3 "Nominal Inlet Turbine SPecific Enthalpy";
            parameter Modelica.SIunits.SpecificEnthalpy h0_outlet3 "Nominal Outlet Turbine SPecific Enthalpy";
            parameter Modelica.SIunits.Power mechPower_nom3 "Nominal Mechanical Power";
            final parameter Real eta_mech_turbine3 = mechPower_nom3 / (wnom_turbine3 * (h0_inlet3 - h0_outlet3)) "Mechanical efficiency";
            parameter Modelica.SIunits.PerUnit theta_nom_valve3 = 0.5 "Nominal valve opening";
            parameter Modelica.SIunits.PerUnit ramp_height3 = 0 "";
            parameter Modelica.SIunits.Time ramp_duration3 = 0.0 "";
            parameter Modelica.SIunits.Time ramp_start_time3 = 0 "";
            parameter Modelica.SIunits.Density rho_nom_valve3 "";
            final parameter Modelica.SIunits.PressureDifference dp_turbine3 = pout_nom3 - po_STEAM3 "";
            parameter Modelica.SIunits.AbsolutePressure po_STEAM3 "Boundary condition for inlet STEAM in the FWPH";
            ...
            ThermoPower.Water.SteamTurbineStodola IP_turbine1(redeclare package Medium = Medium, explicitIsentropicEnthalpy = true, wstart = wnom_turbine1, PRstart = pnom_turbine1 / pout_nom1, wnom = wnom_turbine1, pnom = pnom_turbine1, eta_mech = eta_mech_turbine1, eta_iso_nom = eta_iso_nom_turbine1, Kt = Kt1);
            Modelica.Blocks.Sources.RealExpression partialArc(y = ParArc1);
            ThermoPower.Water.SourcePressure sourcePressure(redeclare package Medium = Medium, h = h0_inlet1, use_T = false, p0 = pnom_turbine1);
            Modelica.Mechanics.Rotational.Sources.ConstantSpeed constantSpeed(w_fixed(displayUnit = "rpm") = 376.99111843078);
            ...
            ThermoPower.Water.ValveVap valveVap1(redeclare package Medium = Medium, CvData = ThermoPower.Choices.Valve.CvTypes.OpPoint, pnom = pout_nom1, dpnom = dp_turbine1, wnom = w_nom_bleeding1, rhonom = rho_nom_valve1, thetanom = theta_nom_valve1);
            Modelica.Blocks.Sources.Ramp ramp1(height = ramp_height1, duration = ramp_duration1, offset = theta_nom_valve1, startTime = ramp_start_time1);
            ThermoPower.Water.SteamTurbineStodola IP_turbine2(redeclare package Medium = Medium, explicitIsentropicEnthalpy = true, wstart = wnom_turbine2, PRstart = pnom_turbine2 / pout_nom2, wnom = wnom_turbine2, pnom = pnom_turbine2, eta_mech = eta_mech_turbine2, eta_iso_nom = eta_iso_nom_turbine2, Kt = Kt2);
            Modelica.Blocks.Sources.RealExpression partialArc1(y = ParArc2);
            ThermoPower.Water.SinkPressure sink_Steam1(use_T = false, redeclare package Medium = Medium, p0 = pout_nom2, h = h0_outlet2);
            ThermoPower.Water.ValveVap valveVap2(redeclare package Medium = Medium, CvData = ThermoPower.Choices.Valve.CvTypes.OpPoint, pnom = pout_nom2, dpnom = dp_turbine2, wnom = w_nom_bleeding2, rhonom = rho_nom_valve2, thetanom = theta_nom_valve2);
            Modelica.Blocks.Sources.Ramp ramp2(height = ramp_height2, duration = ramp_duration2, offset = theta_nom_valve2, startTime = ramp_start_time2);
            ...
            ThermoPower.Water.SteamTurbineStodola IP_turbine3(redeclare package Medium = Medium, explicitIsentropicEnthalpy = true, wstart = wnom_turbine3, PRstart = pnom_turbine3 / pout_nom3, wnom = wnom_turbine3, pnom = pnom_turbine3, eta_mech = eta_mech_turbine3, eta_iso_nom = eta_iso_nom_turbine3, Kt = Kt3);
            Modelica.Blocks.Sources.RealExpression partialArc2(y = ParArc3);
            ThermoPower.Water.SourcePressure sourcePressure1(redeclare package Medium = Medium, h = h0_inlet3, use_T = false, p0 = pnom_turbine3);
            ThermoPower.Water.ValveVap valveVap3(redeclare package Medium = Medium, CvData = ThermoPower.Choices.Valve.CvTypes.OpPoint, pnom = pout_nom3, dpnom = dp_turbine3, wnom = w_nom_bleeding3, rhonom = rho_nom_valve3, thetanom = theta_nom_valve3);
            Modelica.Blocks.Sources.Ramp ramp3(height = ramp_height3, duration = ramp_duration3, offset = theta_nom_valve3, startTime = ramp_start_time3);
            ThermoPower.Water.SinkPressure sink_Steam2(use_T = false, redeclare package Medium = Medium, p0 = pout_nom3, h = h0_outlet3);
            ThermoPower.Water.SensW senswnextturbine1(redeclare package Medium = Medium);
            ThermoPower.Water.SensT sensTout_turbine1(redeclare package Medium = Medium);
            ThermoPower.Water.SensT sensTout_turbine2(redeclare package Medium = Medium);
            ThermoPower.Water.SensW senswnextturbine2(redeclare package Medium = Medium);
          equation
            connect(IP_turbine1.shaft_b, constantSpeed.flange);
            connect(IP_turbine1.inlet, sourcePressure.flange);
            connect(partialArc.y, IP_turbine1.partialArc);
            connect(valveVap1.theta, ramp1.y);
            connect(partialArc1.y, IP_turbine2.partialArc);
            connect(valveVap2.theta, ramp2.y);
            connect(IP_turbine1.outlet, valveVap1.inlet);
            connect(IP_turbine1.outlet, IP_turbine2.inlet);
            connect(IP_turbine2.shaft_b, constantSpeed.flange);
            connect(DRAINout.flange, sensWDR.outlet);
            connect(IP_turbine3.shaft_b, constantSpeed.flange);
            connect(IP_turbine3.inlet, sourcePressure1.flange);
            connect(partialArc2.y, IP_turbine3.partialArc);
            connect(valveVap3.theta, ramp3.y);
            connect(IP_turbine3.outlet, valveVap3.inlet);
            connect(IP_turbine2.outlet, valveVap2.inlet);
            connect(senswnextturbine1.outlet, sink_Steam1.flange);
            connect(IP_turbine2.outlet, sensTout_turbine1.inlet);
            connect(sensTout_turbine1.outlet, senswnextturbine1.inlet);
            connect(IP_turbine3.outlet, sensTout_turbine2.inlet);
            connect(sensTout_turbine2.outlet, senswnextturbine2.inlet);
            connect(senswnextturbine2.outlet, sink_Steam2.flange);
          end Test_FWPH_3Turbine_Boundaries;

          model Test_FWPHs_14_13_12  
            Modelica.SIunits.Temperature AA_T_steam_out_turbine1 = Medium.temperature_ph(IP_turbine1.outlet.p, IP_turbine1.outlet.h_outflow);
            Modelica.SIunits.MassFlowRate w_FWin1 = fWPH_13_1.FWin.m_flow;
            Modelica.SIunits.MassFlowRate w_FWout1 = fWPH_13_1.FWout.m_flow;
            Modelica.SIunits.MassFlowRate w_DRAINin1 = fWPH_13_1.DRAINin.m_flow;
            Modelica.SIunits.MassFlowRate w_DRAINout1 = fWPH_13_1.DRAINout.m_flow;
            Modelica.SIunits.MassFlowRate w_Bleeding1 = fWPH_13_1.STEAMin.m_flow;
            Medium.ThermodynamicState FWin_state1 = Medium.setState_ph(fWPH_13_1.FWin.p, fWPH_13_1.FWin.h_outflow);
            Medium.ThermodynamicState FWout_state1 = Medium.setState_ph(fWPH_13_1.FWout.p, fWPH_13_1.FWout.h_outflow);
            Medium.ThermodynamicState DRAINin_state1 = Medium.setState_ph(fWPH_13_1.DRAINin.p, fWPH_13_1.DRAINin.h_outflow);
            Medium.ThermodynamicState DRAINout_state1 = Medium.setState_ph(fWPH_13_1.flowDRAIN.outfl.p, fWPH_13_1.flowDRAIN.outfl.h_outflow);
            Medium.ThermodynamicState Bleeding_state1 = fWPH_13_1.flowSTEAM.fluidState[1];
            Modelica.SIunits.Power Q_c1 = fWPH_13_1.flowFW_cond.Q;
            Modelica.SIunits.Power Q_d1 = fWPH_13_1.flowFW_des.Q;
            Modelica.SIunits.Power Q_s1 = fWPH_13_1.flowFW_sub.Q;
            Modelica.SIunits.Power Q_tot1 = Q_c1 + Q_d1 + Q_s1;
            Modelica.SIunits.Temperature AA_T_steam_out_turbine2 = Medium.temperature_ph(IP_turbine2.outlet.p, IP_turbine2.outlet.h_outflow);
            Modelica.SIunits.MassFlowRate w_FWin2 = fWPH_14_1.FWin.m_flow;
            Modelica.SIunits.MassFlowRate w_FWout2 = fWPH_14_1.FWout.m_flow;
            Modelica.SIunits.MassFlowRate w_DRAINin2 = fWPH_14_1.DRAINin.m_flow;
            Modelica.SIunits.MassFlowRate w_DRAINout2 = fWPH_14_1.DRAINout.m_flow;
            Modelica.SIunits.MassFlowRate w_Bleeding2 = fWPH_14_1.STEAMin.m_flow;
            Medium.ThermodynamicState FWin_state2 = Medium.setState_ph(fWPH_14_1.FWin.p, fWPH_14_1.FWin.h_outflow);
            Medium.ThermodynamicState FWout_state2 = Medium.setState_ph(fWPH_14_1.FWout.p, fWPH_14_1.FWout.h_outflow);
            Medium.ThermodynamicState DRAINin_state2 = Medium.setState_ph(fWPH_14_1.DRAINin.p, fWPH_14_1.DRAINin.h_outflow);
            Medium.ThermodynamicState DRAINout_state2 = Medium.setState_ph(fWPH_14_1.flowDRAIN.outfl.p, fWPH_14_1.flowDRAIN.outfl.h_outflow);
            Medium.ThermodynamicState Bleeding_state2 = fWPH_14_1.flowSTEAM.fluidState[1];
            Modelica.SIunits.Power Q_c2 = fWPH_14_1.flowFW_cond.Q;
            Modelica.SIunits.Power Q_d2 = fWPH_14_1.flowFW_des.Q;
            Modelica.SIunits.Power Q_s2 = fWPH_14_1.flowFW_sub.Q;
            Modelica.SIunits.Power Q_tot2 = Q_c2 + Q_d2 + Q_s2;
            Modelica.SIunits.Temperature AA_T_steam_out_turbine3 = Medium.temperature_ph(IP_turbine3.outlet.p, IP_turbine3.outlet.h_outflow);
            Modelica.SIunits.MassFlowRate w_FWin3 = fWPH_12_1.FWin.m_flow;
            Modelica.SIunits.MassFlowRate w_FWout3 = fWPH_12_1.FWout.m_flow;
            Modelica.SIunits.MassFlowRate w_DRAINin3 = fWPH_12_1.DRAINin.m_flow;
            Modelica.SIunits.MassFlowRate w_DRAINout3 = fWPH_12_1.DRAINout.m_flow;
            Modelica.SIunits.MassFlowRate w_Bleeding3 = fWPH_12_1.STEAMin.m_flow;
            Medium.ThermodynamicState FWin_state3 = Medium.setState_ph(fWPH_12_1.FWin.p, fWPH_12_1.FWin.h_outflow);
            Medium.ThermodynamicState FWout_state3 = Medium.setState_ph(fWPH_12_1.FWout.p, fWPH_12_1.FWout.h_outflow);
            Medium.ThermodynamicState DRAINin_state3 = Medium.setState_ph(fWPH_12_1.DRAINin.p, fWPH_12_1.DRAINin.h_outflow);
            Medium.ThermodynamicState DRAINout_state3 = Medium.setState_ph(fWPH_12_1.flowDRAIN.outfl.p, fWPH_12_1.flowDRAIN.outfl.h_outflow);
            Medium.ThermodynamicState Bleeding_state3 = fWPH_12_1.flowSTEAM.fluidState[1];
            Modelica.SIunits.Power Q_c3 = fWPH_12_1.flowFW_cond.Q;
            Modelica.SIunits.Power Q_d3 = fWPH_12_1.flowFW_des.Q;
            Modelica.SIunits.Power Q_s3 = fWPH_12_1.flowFW_sub.Q;
            Modelica.SIunits.Power Q_tot3 = Q_c3 + Q_d3 + Q_s3;
            extends Test_FWPH_3Turbine_Boundaries(eta_iso_nom_turbine3 = 0.875933952, po_STEAM3 = 5835000, rho_nom_valve3(displayUnit = "kg/m3") = 25, mechPower_nom3 = 37989000, h0_outlet3 = 2985000, h0_inlet3 = 3082000, T_outlet3 = 603.15, T_inlet3 = 663.45, w_nom_bleeding3 = 23.86, wnom_turbine3 = 393.5, pout_nom3 = 6000000, pnom_turbine3 = 9356000, mechPower_nom2 = 52725000, h0_outlet2 = 3308000, h0_inlet2 = 3455000, rho_nom_valve2(displayUnit = "kg/m3") = 6.527, eta_iso_nom_turbine2 = 0.889824638, T_outlet2 = 700.85, T_inlet2 = 774.15, w_nom_bleeding2 = 14.01, wnom_turbine2 = 360.7, pout_nom2 = 2062000, pnom_turbine2 = 3402000, po_STEAM2 = 2012000, mechPower_nom1 = 56885000, h0_outlet1 = 3455000, h0_inlet1 = 3613000, rho_nom_valve1(displayUnit = "kg/m3") = 9.777, eta_iso_nom_turbine1 = 0.911389142, T_outlet1 = 774.15, T_inlet1 = 851.95, w_nom_bleeding1 = 13.95, wnom_turbine1 = 374.6, pout_nom1 = 3402000, pnom_turbine1 = 5490000, po_STEAM1 = 3313000, wo_FW_in = 347.5, ho_FW_in = 804210, po_DRAIN_out = 972600, ho_DRAIN_out = 810840, wo_DRAIN_in = 31.11, ho_DRAIN_in = 1226600, po_FW_out = 32086000, ho_FW_out = 1197470, IP_turbine3(usePartialArcInput = true, phi(fixed = true)), IP_turbine1(usePartialArcInput = true), IP_turbine2(usePartialArcInput = true));
            FlexiCaL.FeedWater.FWPHs_Accurate.Sized_FWPHs.FWPH_12 fWPH_12_1;
            FlexiCaL.FeedWater.FWPHs_Accurate.Sized_FWPHs.FWPH_13 fWPH_13_1;
            FlexiCaL.FeedWater.FWPHs_Accurate.Sized_FWPHs.FWPH_14 fWPH_14_1;
          equation
            connect(valveVap3.outlet, fWPH_12_1.STEAMin);
            connect(valveVap1.outlet, fWPH_13_1.STEAMin);
            connect(valveVap2.outlet, fWPH_14_1.STEAMin);
            connect(fWPH_12_1.FWin, fWPH_13_1.FWout);
            connect(fWPH_13_1.FWin, fWPH_14_1.FWout);
            connect(fWPH_14_1.FWin, FWin.flange);
            connect(FWout.flange, fWPH_12_1.FWout);
            connect(DRAINin.flange, fWPH_12_1.DRAINin);
            connect(fWPH_12_1.DRAINout, fWPH_13_1.DRAINin);
            connect(fWPH_13_1.DRAINout, fWPH_14_1.DRAINin);
            connect(fWPH_14_1.DRAINout, sensWDR.inlet);
            annotation(experiment(StopTime = 1000)); 
          end Test_FWPHs_14_13_12;
        end Tests_with_turbine;
...
model Test
  extends FlexiCaL.FeedWater.Tests.Tests_FWPHs_Accurate.Tests_with_turbine.Test_FWPHs_14_13_12;
 annotation(experiment(StopTime = 1000));
end Test;
